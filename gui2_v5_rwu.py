...
def main(page: ft.page):
    ...
    ontologyBoxText = ft.Text(value='Ontology Search', 
                              #width=500,
                              #height=50,
                              color="BLUE",
                              #bgcolor="#1976D2", 
    ...
    #Create a bos for the search button and text ###IDK what it's this????
    search_box = ft.Container(expand=True,bgcolor="EAEAEA")
